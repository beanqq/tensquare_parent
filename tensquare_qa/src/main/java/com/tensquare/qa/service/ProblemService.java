...
public class ProblemService {
	...
	public Page<Problem> findNewList(String labelId,int page,int size){
		...
		Page<Problem>  newList = problemDao.findNewListByLabelId(labelId, pageable);
		return newList;
	}
 ...
 public Page<Problem> findHotList(String labelId,int page,int size){
 	Pageable pageable=PageRequest.of(page-1,size);
	 Page<Problem> hostList = problemDao.findHotListByLabelId(labelId, pageable);
	 return hostList;
 }
	...
	public Page<Problem> findWaitList(String labelId,int page,int size){
		Pageable pageable=PageRequest.of(page-1,size);
		Page<Problem> hostList = problemDao.findWaitListByLabelId(labelId, pageable);
		return hostList;
	}
